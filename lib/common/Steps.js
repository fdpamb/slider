...
var Steps = function Steps(_ref) {
  ...
  var elements = calcPoints(vertical, marks, dots, step, min, max).map(function (point) {
    ...
    var pointClassName = (0, _classnames.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-dot"), true), "".concat(prefixCls, "-dot-active"), isActived), "".concat(prefixCls, "-dot-reverse"), reverse));
