...
function createSlider(Component) {
  var _ComponentEnhancer;
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  return _ComponentEnhancer = /*#__PURE__*/function (_Component) {
    function ComponentEnhancer(props) {
      var _this;
      (0, _classCallCheck2.default)(this, ComponentEnhancer);
      _this = (0, _callSuper2.default)(this, ComponentEnhancer, [props]);
    ...
    return (0, _createClass2.default)(ComponentEnhancer, [{
      ...
      value: function render() {
        ...
        var sliderClassName = (0, _classnames.default)(prefixCls, (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-with-marks"), Object.keys(marks).length), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-vertical"), vertical), className, className));
  ...
  }(Component), _ComponentEnhancer.displayName = "ComponentEnhancer(".concat(Component.displayName, ")"), _ComponentEnhancer.defaultProps = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, Component.defaultProps), {}, {
    prefixCls: 'rc-slider',
    className: '',
    min: 0,
    max: 100,
