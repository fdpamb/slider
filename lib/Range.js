...
var Range = /*#__PURE__*/function (_React$Component) {
  function Range(props) {
    ...
    _this = (0, _callSuper2.default)(this, Range, [props]);
    ...
    value: function render() {
      ...
      var handles = bounds.map(function (v, i) {
        ...
        return handleGenerator({
          className: (0, _classnames.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, handleClassName, true), "".concat(handleClassName, "-").concat(i + 1), true), "".concat(handleClassName, "-dragging"), dragging)),
          prefixCls: prefixCls,
          vertical: vertical,
          dragging: dragging,
          offset: offsets[i],
      ...
      var tracks = bounds.slice(0, -1).map(function (_, index) {
        var i = index + 1;
        var trackClassName = (0, _classnames.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-track"), true), "".concat(prefixCls, "-track-").concat(i), true));
...
var _default = exports.default = (0, _createSlider.default)(Range);