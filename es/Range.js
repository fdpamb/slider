    ...
    value: function render() {
      ...
      var handles = bounds.map(function (v, i) {
        ...
        return handleGenerator({
          className: classNames(_defineProperty(_defineProperty(_defineProperty({}, handleClassName, true), "".concat(handleClassName, "-").concat(i + 1), true), "".concat(handleClassName, "-dragging"), dragging)),
          prefixCls: prefixCls,
          vertical: vertical,
          dragging: dragging,
          offset: offsets[i],
      ...
      var tracks = bounds.slice(0, -1).map(function (_, index) {
        var i = index + 1;
        var trackClassName = classNames(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-track"), true), "".concat(prefixCls, "-track-").concat(i), true));
