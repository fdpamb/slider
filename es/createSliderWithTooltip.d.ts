...
export default function createSliderWithTooltip<Props extends GenericSliderProps>(Component: React.ComponentClass<Props>): {
    new (props: (ComponentWrapperProps & Props) | Readonly<ComponentWrapperProps & Props>): {
        ...
        context: any;
        setState<K extends "visibles">(state: ComponentWrapperState | ((prevState: Readonly<ComponentWrapperState>, props: Readonly<ComponentWrapperProps & Props>) => Pick<ComponentWrapperState, K> | ComponentWrapperState | null) | Pick<ComponentWrapperState, K>, callback?: () => void): void;
        ...
        getSnapshotBeforeUpdate?(prevProps: Readonly<ComponentWrapperProps & Props>, prevState: Readonly<ComponentWrapperState>): any | null;
