...
var Steps = function Steps(_ref) {
  ...
  var elements = calcPoints(vertical, marks, dots, step, min, max).map(function (point) {
    ...
    var pointClassName = classNames(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-dot"), true), "".concat(prefixCls, "-dot-active"), isActived), "".concat(prefixCls, "-dot-reverse"), reverse));
