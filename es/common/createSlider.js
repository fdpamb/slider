...
export default function createSlider(Component) {
  ...
  return _ComponentEnhancer = /*#__PURE__*/function (_Component) {
    ...
    return _createClass(ComponentEnhancer, [{
      ...
      value: function render() {
        ...
        var sliderClassName = classNames(prefixCls, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-with-marks"), Object.keys(marks).length), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-vertical"), vertical), className, className));
  ...
  }(Component), _ComponentEnhancer.displayName = "ComponentEnhancer(".concat(Component.displayName, ")"), _ComponentEnhancer.defaultProps = _objectSpread(_objectSpread({}, Component.defaultProps), {}, {
    prefixCls: 'rc-slider',
    className: '',
    min: 0,
    max: 100,
