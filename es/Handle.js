...
var Handle = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(Handle, [{
    ...
    value: function render() {
      ...
      var positionStyle = vertical ? _defineProperty(_defineProperty(_defineProperty({}, reverse ? 'top' : 'bottom', "".concat(offset, "%")), reverse ? 'bottom' : 'top', 'auto'), "transform", reverse ? null : "translateY(+50%)") : _defineProperty(_defineProperty(_defineProperty({}, reverse ? 'right' : 'left', "".concat(offset, "%")), reverse ? 'left' : 'right', 'auto'), "transform", "translateX(".concat(reverse ? '+' : '-', "50%)"));
